...
def spotify_metadata(song_name, metadata):
    ...
    if 'error' in data:
        set_spotify_token()
        return spotify_metadata(song_name, metadata)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default='C:\\temp\\unmix.io\\', type=str, help='Working path')
